...
- Create the bug doc in the `project/bugs/` directory with filename: `bug-{descriptive-name}.md`
...
- IMPORTANT: Bugs don't need implementation plans. Document the bug, fix it, mark done.
